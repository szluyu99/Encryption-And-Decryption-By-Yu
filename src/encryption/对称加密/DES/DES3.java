 ...
 * To use this class:
 *
 * 1. set the initial vector (IV) using DES2.setIv(long iv)
 * 2. to Encrypt use DES2.encryptCBC(byte[] plaintext, byte[] key)
 * 3. to Decrypt use DES2.decryptCBC(byte[] ciphertext, byte[] key)
 *
 */

/**
 * Super-slow DES2 implementation for the overly patient.
 * <p/>
 ...
 * <p/>
 * "The DES2 Algorithm Illustrated" by J. Orlin Grabbe
 * http://orlingrabbe.com/des.htm
 * <p/>
 * "DES2 Calculator" by Lawrie Brown
...
public class DES3 {
    ...
    //////////////////////////////////////////////////////////////////////
    //
    // Various static data tables used by the DES2 algorithm.
    //
     ...
     * "The S-boxes provide the core of the security of DES2 - without
     ...
     * to this table into a 56-bit key.  (This is why DES2 is only a
    ...
    //////////////////////////////////////////////////////////////////////
    //
    // Primary DES2 algorithm methods
    //
    //////////////////////////////////////////////////////////////////////

    /**
     * The Feistel function is the heart of DES2.
     */
    ...
    //////////////////////////////////////////////////////////////////////
    //
    // High-level interface to the DES2 algorithm
    //
    //////////////////////////////////////////////////////////////////////
     ...
     * bit-positions of the 64-bit DES2 key input.  The ever-popular
     * 7-bit ASCII characters have useful information in the least
     * significant bit which is discarded by DES2, and always have zero
     ...
     * receiving a 16 byte challenge, encrypting it with DES2 using the
    ...
    // for providing confidence in this DES2 implementation.
    //
    //////////////////////////////////////////////////////////////////////
    ...
    public static String hexStr2Str(String hexStr) {
	 ...
	 public static String encryptByYu(String oriText, String key){
     ...
     public static String decryptByYu(String password, String key){
         byte[] keys = parseBytes(key);
         byte[] encResult = parseBytes(password);
         String decResult = hex(decryptCBC(encResult,keys));
         // System.out.println("Decryption result:  " + decResult);
         // System.out.println(hexStr2Str(decResult));
         return decResult;
     }

    public static void main(String[] args) {
        String orignText = "luzhenyu";
        String key = "17210224";
        String password = encryptByYu(orignText, key);
        System.out.println("Password:" + password);
        System.out.println("OriText:" + decryptByYu(password, key));
    }
